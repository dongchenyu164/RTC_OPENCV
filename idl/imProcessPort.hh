...
public:
  ...
  virtual ::CORBA::Long getCupRimLevel_InPixle() = 0;
  virtual ::CORBA::Long getLiquidLevel_InPixle() = 0;
  virtual ::CORBA::Boolean getBackgroundToAlgorithm() = 0;
  virtual ::CORBA::Boolean getEmptyCupToAlgorithm() = 0;
